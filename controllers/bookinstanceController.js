...
exports.bookinstance_update_get = function(req, res, next) {
	...
	async.parallel({
		...
		res.render('bookinstance_form', { title: 'Update Book Instance', book_list: results.books, selected_book: results.bookinstance.book._id, bookinstance: results.bookinstance, due_back: results.bookinstance.due_back_formatted });
	});
};
